  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl shadow-lg p-6 hover-lift border border-pink-200 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-primary-700">Total Agendamentos</p>
              <p className="text-3xl font-bold text-primary-600 mt-2">
                {estatisticas?.total || 0}
              </p>
            </div>
            <div className="bg-gradient-to-br from-primary-400 to-primary-500 p-3 rounded-xl shadow-md">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg p-6 hover-lift border border-orange-200 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-orange-700">Agendamentos Hoje</p>
              <p className="text-3xl font-bold text-orange-600 mt-2">
                {estatisticas?.hoje || 0}
              </p>
            </div>
            <div className="bg-gradient-to-br from-orange-400 to-orange-500 p-3 rounded-xl shadow-md">
              <svg className="w-8 h-8 text-white" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg p-6 hover-lift border border-yellow-200 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-yellow-700">Receita Mensal</p>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg p-6 hover-lift border border-purple-200 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-purple-700">Pendentes</p>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
        <h2 className="text-2xl font-bold bg-gradient-to-r from-primary-500 to-orange-500 bg-clip-text text-transparent mb-4">Eventos de Hoje</h2>
        {agendamentosHoje.length === 0 ? (
          ...
          <div className="space-y-3">
            {agendamentosHoje.map((agendamento) => (
              <div
                key={agendamento.id}
                className="flex items-center justify-between p-4 bg-gradient-to-r from-pink-50/50 to-purple-50/50 rounded-xl hover:scale-[1.02] hover:shadow-md transition-all cursor-pointer border-l-4 border-primary-400"
              ...
              >
                ...
                <div className="text-right ml-4">
                  ...
                  <span
                    className={`inline-block px-3 py-1 text-xs rounded-full mt-1 font-medium border ${
