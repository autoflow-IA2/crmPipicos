      ...
      <div className="p-6 flex items-center justify-between border-b border-white/10">
        {!isCollapsed ? (
          <div className="flex items-center gap-3 animate-fadeIn">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300 p-1">
              <img
          ...
          <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300 p-1 mx-auto">
            <img
              src="https://gjqkkiuqryhhobmcevuo.supabase.co/storage/v1/object/public/pipicos/logo.png"
              alt="Pipicos Festas"
              className="w-full h-full object-contain"
        ...
        <button
          ...
          className={`p-2 rounded-lg hover:bg-white/10 transition-all duration-200 transform hover:scale-110 ${isCollapsed ? 'absolute top-6 right-2' : ''}`}
