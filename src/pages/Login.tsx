        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-primary-100">
          ...
          <div className="p-8">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-primary-200 hover:bg-primary-50/50 transition-all group">
