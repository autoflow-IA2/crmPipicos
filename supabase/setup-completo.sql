-- Setup Completo: Corrigir RLS + Importar Brinquedos
-- Execute este script completo no SQL Editor do Supabase

-- ============================================
-- PASSO 1: Corrigir Políticas de RLS
-- ============================================
...
-- Permitir inserção/atualização/deleção para todos (incluindo anon)
...
DROP POLICY IF EXISTS "Permitir gestão de agendamentos para autenticados" ON agendamentos;
...
SELECT
    ...
    SUM(valor_locacao * quantidade_estoque) as valor_total_estoque
FROM brinquedos
GROUP BY categoria
ORDER BY categoria;

SELECT
    '✅ Total de brinquedos importados: ' || COUNT(*) || ' tipos' as resultado,
    '📦 Total de unidades: ' || SUM(quantidade_estoque) as unidades
FROM brinquedos;
